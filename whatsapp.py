...
whatsapp.make_admin_to_group(group_name='Test', contact_name='پوریا', contact_phone_number='+989362190659')
# text = 'Pourya been just made admin by dovinance cool whatsapp bot.'
